...
// I introduced this variable to handle addIceCandidate successfully.
// If remoteDescription is not created when addIceCanddiate, throw DOMException.
...
// Update URL on the page so that users can copy&paste it to their peers.
// function updateRoomURL(ipaddr) {
//     var url;
//     if (!ipaddr) {
//         url = location.href;
//     } else {
//         url = location.protocol + '//' + ipaddr
//  + ':2013/#' + room;
//     }
...
function gotStream(stream) {
  ...
  video.onloadedmetadata = function () {
    ...
    console.log(
      "gotStream with width and heigth:",
      photoContextW,
      photoContextH
    );
  };
...
function signalingMessageCallback(message) {
  ...
  if (message.type === "offer") {
    ...
    if (message.candidate && remoteDescriptionSet === true) {
...
function sendPhoto() {
  ...
  console.log("Sending a total of " + len + " bytes(s)");
